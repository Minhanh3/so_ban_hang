    ...
    <div className="max-w-5xl mx-auto space-y-6 animate-fade-in pb-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm">
          <div className="flex items-center gap-3 mb-2">
            ...
            <span className="text-slate-500 font-bold text-sm">Doanh thu</span>
          </div>
          <p className="text-3xl font-black text-slate-900">{summary.revenue.toLocaleString()}đ</p>
        ...
        <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm">
          <div className="flex items-center gap-3 mb-2">
            ...
            <span className="text-slate-500 font-bold text-sm">Chi phí (Giá vốn)</span>
          </div>
          <p className="text-3xl font-black text-slate-900">{summary.cost.toLocaleString()}đ</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 bg-white p-6 rounded-3xl border border-slate-100 shadow-sm">
          <h3 className="font-bold text-lg text-slate-800 mb-6">Biểu đồ tăng trưởng</h3>
        ...
        <div className="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm flex flex-col items-center justify-center">
          <h3 className="font-bold text-lg text-slate-800 mb-2 w-full text-left">Cấu trúc dòng tiền</h3>
          <div className="h-[250px] w-full flex items-center justify-center relative">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
              <span className="text-2xl font-black text-slate-800">{summary.revenue ? Math.round((summary.profit / summary.revenue) * 100) : 0}%</span>
              <span className="text-xs text-slate-500 font-bold uppercase">Margin</span>
            </div>
          </div>
        ...
        <div className="bg-white rounded-[2rem] border border-slate-100 shadow-sm overflow-hidden">
          ...
          <div className="divide-y divide-slate-50">
            <div className="p-4 flex justify-between items-center hover:bg-slate-50 transition-colors">
              ...
              <span className="font-bold text-slate-900">{summary.revenue.toLocaleString()}</span>
            </div>
            <div className="p-4 flex justify-between items-center hover:bg-slate-50 transition-colors">
